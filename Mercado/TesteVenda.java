...
public class TesteVenda {
	...
	public static void main(String[] args) {
		...
		Double total = produto1.vender(produto1.getQuantidadeDeItens())
				+ produto2.vender(produto2.getQuantidadeDeItens()) + produto3.vender(produto3.getQuantidadeDeItens())
				+ produto4.vender(produto4.getQuantidadeDeItens()) + produto5.vender(produto5.getQuantidadeDeItens());
